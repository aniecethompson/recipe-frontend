...
function FullRecipe () {
    ...
    const [recipeInfo, setRecipeInfo] = useState({dishTypes: [], cuisines: [], diets: [] ,extendedIngredients: [], analyzedInstructions: [] })
    ...
    const { title, readyInMinutes, servings, image, dishTypes, cuisines, diets, preparationMinutes, cookingMinutes, extendedIngredients, analyzedInstructions} = recipeInfo
    ...
    return (
                    ...
                    <div>
                          <div className="full-container">
                            ...
                            {similarRecipes.map((recipe) => <Buffer key={recipe.id} onlineId={recipe.id}/>)}
                            </div>
